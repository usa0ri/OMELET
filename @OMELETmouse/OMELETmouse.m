classdef OMELETmouse < handle
    ...
    methods
        function obj = OMELETmouse(rstan_path,model_path,data_path)
            % rstan_path: path to directory where results of OMELET from Rstan are saved
            % model_path: path to model_data created by make_CCMmodel.m
