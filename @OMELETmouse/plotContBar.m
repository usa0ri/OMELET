...
%     fname_str = [savedir '/total'];
%     plot_cont(opts.cont.total,fname_str,model_data,is_errorbar,opts);
% 
%     % group
%     for g=1:num_g
%         fname_str = [savedir '/' grp_names{g} ];
%         plot_cont(opts.cont.grp(:,:,:,g),fname_str,model_data,is_errorbar,opts);
%     end
