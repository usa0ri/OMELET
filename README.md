...
+ `OMELET_rstan/run_OMELETmouse.R`
  ...
  This code performs parameter estimation of `OMELET_rstan/OMELETmouse.stan` model. You need to prepare `OMELET_rstan/input_OMELETmouse` directory of input data, which is generated by `make_input_OMELET/make_input_OMELETmouse.m`. This script also makes Figure 3A.
